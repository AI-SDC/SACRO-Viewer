      ...
      <li>
        <ul class="mt-2">
          <li>
            ...
            <ul>
              <button name="approve" class="approve inline-flex items-center justify-center rounded-md shadow-sm transition-buttons duration-200 px-4 py-2 text-sm font-medium bg-blue-600 text-white hover:bg-blue-700 focus:bg-blue-700 focus:ring-blue-500 focus:ring-offset-white">Approve</button>
