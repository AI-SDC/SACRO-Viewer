...
1. Download the [latest release build](https://github.com/AI-SDC/SACRO-Viewer/releases/download/v0.2.0/SACRO-0.2.0-windows-build.zip).
...
1. Download the [latest release build](https://github.com/AI-SDC/SACRO-Viewer/releases/download/v0.2.0/SACRO-0.2.0-linux-build.zip).
2. Unzip the downloaded zipfile.
...
1. Download the [latest release build](https://github.com/AI-SDC/SACRO-Viewer/releases/download/v0.2.0/SACRO-0.2.0-macos-build.zip).
2. Unzip the downloaded zipfile
